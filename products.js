...
function moncatuDemoCatalog() {
  ...
  return [
    ...
    { id: "A022", sku: "A022", name: "Anillo Samurái de Plata .925 para Hombre", category: "anillos", price: 349, material: "Plata .925", finish: "Ajustable · Estilo samurái", color: "Plateado oxidado con detalle dorado", stock: 1, active: true, featured: true,
      images: ["/img/a022-1.webp", "/img/a022-2.webp", "/img/a022-modelo.webp"],
      description: "Descubre el Anillo Moncatu Samurai, una pieza de joyería que combina modernidad y tradición en un diseño exclusivo para hombres. Fabricado en plata 925, este anillo no solo destaca por su calidad superior, sino también por su estilo único que evoca la fuerza y la valentía del samurái. El Anillo Moncatu Samurai es ideal para aquellos que buscan un accesorio que complemente su personalidad fuerte y decidida. Su diseño en moda contemporánea se adapta perfectamente a diversas ocasiones, ya sea para una cita especial o para realzar tu día a día con un toque sofisticado. Cada detalle de este anillo ha sido cuidadosamente elaborado, asegurando una experiencia de uso cómoda y duradera. La pureza del metal 925 garantiza que lleves contigo una pieza que resalta la elegancia sin sacrificar la resistencia. Este anillo no solo es un accesorio, sino una declaración de estilo personal que resuena con hombres de todas las edades." },

    { id: "A023", sku: "A023", name: "Aretes Largos Ave Paloma de Plata .925", category: "aretes", price: 1449, material: "Plata .925", finish: "Aretes largos · Hipoalergénico", color: "Plateado", stock: 1, active: true, featured: true,
      images: ["/img/a023-1.webp", "/img/a023-2.webp", "/img/a023-modelo.webp"],
      description: "Los aretes Moncatu en plata 925 son la elección ideal para quienes buscan complementar su estilo con una pieza clásica y atemporal. Diseñados cuidadosamente, su forma de paloma evoca elegancia y sofisticación en cada uso. La plata 925 garantiza durabilidad y un acabado brillante, convirtiéndolos en un imprescindible en cualquier colección de joyería fina. Estos aretes largos son perfectos tanto para una ocasión especial como para el uso diario, asegurando que cada conjunto se vea elegante. Además, su diseño hipoalergénico los hace aptos para todo tipo de piel, brindando comodidad y seguridad en cada momento. La simplicidad de su estilo permite que los aretes Moncatu se integren fácilmente a diferentes looks, desde el más casual hasta el más formal. Sorprende a esa persona especial con un detalle que no solo embellece, sino que también expresa un mensaje de amor y aprecio." }
  ];
}
